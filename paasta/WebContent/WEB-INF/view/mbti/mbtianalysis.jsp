						...
						<div class="col-xl-8 py-4 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="row p-2">
								<div class="card p-l-55 p-r-55 p-t-65 p-b-54 shadowbox col-12" style="font-family: 'Do Hyeon', sans-serif; font-family: 'Nanum Pen Script', cursive; font-size: 20px;">
									...
									<!-- 시작 화면 -->
									<article class="start mt-3 mb-3">
										<label style="text-align:center; font-size: 27px; font-family: 'Do Hyeon', sans-serif; font-family: 'Nanum Pen Script', cursive;color: deepskyblue;">
										MBTI 성격 유형 검사는 총 12문제 입니다.</label>
										<img id="basic" class="mt-3 mb-3" src="/andrea-master/images/mbtiex01.png" alt="">
										<p style="text-align:center; font-size: 20px;color: red;">※ 정확하지 않을수 있으나 <br>잘맞는 성향의 팀원을 찾기위해 꼭 필요합니다.</p>
									...
									<article class="result">
										...
										<h2 id="animal" class="text-center mt-2" style="font-family: 'Do Hyeon', sans-serif; font-family: 'Nanum Pen Script', cursive; font-size: 30px;">
										이름</h2>
										<h3 id="explain" class="mt-2" style="font-family: 'Do Hyeon', sans-serif; font-family: 'Nanum Pen Script', cursive; font-size: 25px;">
										&nbsp&nbsp설명</h3>
										<!-- Go to www.addthis.com/dashboard to customize your tools --> 
										<div class="share addthis_inline_share_toolbox mb-3"></div>
										<div style="text-align: center; font-size:30px;">
											결과는 <span class="mbti" style="font-size:27px;"></span> 입니다.
											<p style="font-size: 24px;color: red;">※ 정확하지 않을수 있으나 <br>잘맞는 성향의 팀원을 찾기위해 필요합니다.</p>
											<button type="button" class="btn btn-success" style="border-radius: 10px; font-size:30px" onclick="goPage()">등록하기</button>
										</div>
									</article>
...
<script>
	...
	var q = {
        ...
        var result = {
            "ISTJ": {"animal": "계획만 세워도 오늘 공부의 반은 했다! 프로계획러 <br><strong>시베리안 허스키</strong>", "explain": "시험일정이 잡혔을 때, 친구들과 약속이 잡혔을 때 먼저 나서서 계획을 세우는 타입이에요. 점심먹을 때는 디저트를, 디저트 먹을 때는 저녁을, 저녁 먹을때는 다음 날 아침을 미리미리 생각해서 결정장애가 있는 주변인에게 사랑받아요. 하지만, 주로 했던 일들 위주로 계획을 세우다보니 도전적인 거에는 서툴 수 있어요. 책임감과 추진력이 강한 당신! 올해는 도전적으로 일을 주도해봐요.", "img": "/andrea-master/images/ISTJ.png"},
            "ISFJ": {"animal": "이 계획으로 밀고가고는 싶지만, 너가 그렇게 하고 싶다면.. 배려왕 <br><strong>슈나우저</strong>", "explain": "다른 사람과 계획을 짤 때 너의 말도, 너의 말도 옳다.는 황희정승형 마인드를 가지고 있어요. 모두를 의견을 듣고 모두가 원하는 방향으로 계획을 세우고 싶어하기 때문에 조금 스트레스를 받기도 해요. 하지만, 본인만의 계획을 세울 땐 확고하게, 완벽한 계획을 세워 달성해나가려고 하는 외유내강 타입이에요. 하지만, 주어진 계획을 잘 이뤄나가지 못할 경우에 큰 스트레스를 받아요. 남들과의 의견 조율에서는 좀 더 본인 의견을 내세우거나 본인의 계획에서는 살짝 여유를 주는게 좋아요.", "img": "/andrea-master/images/ISFJ.png"},
            "INFJ": {"animal": "계획적으로 생활하는 것이 곧 삶의 기쁨 스케쥴러 <br><strong>진돗개</strong>", "explain": "첫 만남에 맘에 드는 상대를 발견하고 결혼까지 생각하는 당신은 일을 진행하면서 계속해서 미래를 상상하고 자극받는 걸 좋아해요. 모든 일에는 이유와 의미가 있다고 생각하는 당신! 그만큼 다 중요하다고 생각하기 때문에 허투루 일을 하는 사람이 아니에요. 그래서 더 목표를 중요하게 여겨요. 계획에는 어떠한 목표가 있는지 확인하고 맞는 계획을 세워 이뤄나가려해요. 완벽한 계획을 추구해요. 그만큼 추진력도 강해 주변에서 믿음직한 사람이라고 많이 들어요.", "img": "/andrea-master/images/INFJ.png"},
            "INTJ": {"animal": "너는 다 계획이 있구나.. 이 모든 것은 나의 큰 그림! 선구자 <br><strong>잭 러셀 테리어</strong>", "explain": "연애 상담을 하다보면 결혼과 출산까지 염두해서 조언을 해주는 당신은 나무보다 숲, 아니 달에서 우주 저만리까지 보는 사람이에요. 큰틀을 우선적으로 생각하다보니 꿈꾸는 목표치가 점점 높아지고, 불어나는 계획들을 자각하지 못하다 다시 돌아가기도 해요. 하지만, 이 모든 건 내 목표를 이루어나가기 위한 것! 들어가는 시간이 곧 '투자'라고 생각하기 때문에 해결책을 찾아 실행해요. 미래를 낙관적으로 판단하는 성향이 있기 때문에 보다 더 강하게 목표를 향해 달려나가려 노력해요.", "img": "/andrea-master/images/INTJ.png"},
            ...
            "ESFP": {"animal": "매일 반복되는 일상이 지루해! 계획적인건 싫어! 언제나 새로운 자극제를 찾아다니는 <br><strong>웰시코기</strong>", "explain": "계획이 곧 족쇄. 계획을 세워 진행하는 일은 틀에 맞춰 사는 것 같아 답답함을 느끼는 자유로운 영혼의 소유자에요. 가끔씩 세우는 계획은 여행이나 운동같이 액티비티성이 강한 활동들을 위한 것이에요. 계획이 틀어져도 상관없어요. 내일은 내일의 해가 뜬다고 생각하기 때문이에요. 하지만 발등에 불이 떨어진 경우 빠르게 일을 처리하는 편이에요.", "img": "/andrea-master/images/ESFP.png"},
            "ENFP": {"animal": "반짝이는 아이디어로 새로운 계획을 짜 지루할 틈이 없는 <br><strong>퍼그</strong>", "explain": "새로운 계획, 새로워, 늘 짜릿해. 도중에 계획이 틀어져도 상관없어요, 아이디어가 반짝반짝 떠오르기 때문이죠. 계획적으로 해야하나 싶으면서도 계획을 세워 시작하면 끝없는 추진력을 얻어 일을 진행하는 타입이에요. 새로운 시도를 좋아해 중간중간 새롭게 계획되는 일들이 있어도 주저하지 않아요. 집단 생활에서 계획이 잘 되어가고 있다면 좋아하는 동료들의 모습을 보고 더 힘을 얻어 일을 추진해요.", "img": "/andrea-master/images/ENFP.png"},
	...
	function goPage() {
		location.href="/mbti/updateUserMbti.do?user_mbti="+mbti;
	}
</script>
</html>